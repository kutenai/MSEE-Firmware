...
Referenced by HardwareSerial::begin2x(), HardwareSerial::end(), HardwareSerial::HardwareSerial(), TimerCntr::TimerCntr(), HardwareSerial::$\sim$HardwareSerial(), and TimerCntr::$\sim$TimerCntr().
