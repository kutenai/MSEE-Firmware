...
References \_\-aID, \_\-bDataReady, \_\-bDualChan, \_\-bRun, \_\-bUseGyro, \_\-busyWaitTime, \_\-ClkSel, \_\-DLPF, \_\-failType, \_\-FullScale, \_\-gID, \_\-numChans, \_\-pDBGPort, \_\-pDBGPort2, \_\-pMas, \_\-pNextIMU, \_\-previousState, \_\-pTimer, \_\-Rate, \_\-State, fNone, QueryChannels(), ResetFailStats(), and sIdle.
...
References \_\-aID, \_\-bDualChan, \_\-bRun, \_\-bUseGyro, \_\-ClkSel, \_\-DLPF, \_\-FullScale, \_\-gID, \_\-numChans, \_\-pDBGPort, \_\-pDBGPort2, \_\-pMas, \_\-pNextIMU, \_\-pTimer, \_\-Rate, \_\-State, ResetFailStats(), and sIdle.
...
\subsubsection[{BeginRead}]{\setlength{\rightskip}{0pt plus 5cm}int IMU::BeginRead (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
References \_\-pNextIMU, \_\-State, IMUBase::BeginRead(), Run(), and sWait.
...
References \_\-bDataReady, \_\-bDualChan, and \_\-numChans.
...
References \_\-bDataReady, \_\-bDualChan, \_\-dataBuffer, \_\-failType, \_\-numChans, \_\-State, fNack, and sIdle.
...
References \_\-bFailDetected, \_\-bRun, \_\-failCount, \_\-failType, \_\-pDBGPort2, \_\-previousState, FailRecovery(), fArbLost, pArbLost, pBusErr, ResetBusyTime(), sErrRecover, SetState(), and StartTransaction().
...
References \_\-bRun, \_\-failType, \_\-nackCount, \_\-pDBGPort2, \_\-previousState, FailRecovery(), fNack, pBusErr, pNack, ResetBusyTime(), sErrRecover, SetState(), StartTransaction(), and Stop().
...
\subsubsection[{NextIMU}]{\setlength{\rightskip}{0pt plus 5cm}void IMU::NextIMU (
\begin{DoxyParamCaption}
...
References \_\-bDualChan, \_\-bUseGyro, \_\-pNextIMU, \_\-State, IMUBase::BeginRead(), PushData(), SetState(), sReadAcc1, sReadAcc2, sReadGyro1, sReadGyro2, StartTransaction(), StoreAccData(), StoreGyroData(), and sWait.
...
\subsubsection[{QueryChannels}]{\setlength{\rightskip}{0pt plus 5cm}void IMU::QueryChannels (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}
...
References \_\-aID, \_\-bDualChan, \_\-gID, \_\-numChans, and \_\-pMas.
...
References \_\-Rate, Print::print(), and SetTimerPeriod().
...
References \_\-bDataReady, \_\-bRun, \_\-numChans, \_\-pDBGPort2, \_\-State, pWriteDn, ResetFailStats(), ResetTimer(), sConfigured, SetState(), Setup(), and sWait.
...
\subsubsection[{\_\-pNextIMU}]{\setlength{\rightskip}{0pt plus 5cm}{\bf IMUBase}$\ast$ {\bf IMU::\_\-pNextIMU}\hspace{0.3cm}{\ttfamily  \mbox{[}private\mbox{]}}}}
